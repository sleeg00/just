...
public class RedisKeyUtil {
    ...
    private static final String POST_LIKE_STREAM_NAME = "post:like:stream";
    private static final String GROUP_NAME = "postLikeGroup";
    ...
    public String getPostLikeStreamName() {
        return POST_LIKE_STREAM_NAME;
    }

    public String getPostLikeGroup() {
        return GROUP_NAME;
    }
}
